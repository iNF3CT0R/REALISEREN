...
<!--
    ...
    KW1C instructie:    REA T3 oef 4.1 scarface
                        - Dit is je voorbeeld: maak de andere drie pagina's zoals deze!
                        - Bekijk ook eerst goed wat er in top.php en bottom.php staat!
                        LET OP: PHP Storm openen als Administrator!
-->
<?php
$title = "Al Pacino in Scarface"; // titel van de pagina
...
<article>
    <h2>Scarface</h2>
    <p id="parscarface">
        <img id="scarface" src="../images/scarface.PNG" alt="Tony Montana">
